...
<section class="portfolio" id="portfolio">
  <div class="container">
    ...
    <div class="row">
      ...
      ?>
      <div class="col-md-4">
        <a class="d-block mx-auto" href="<?php echo the_permalink();?>">
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-lg-4 ml-auto">
        ...
        <p class="lead">
        Este blog foi idealizado através da leitura do livro <a class = "a-secondary" href="https://austinkleon.com/show-your-work/">"Show your work" - ("Mostre o seu trabalho")</a> de <a class = "a-secondary" href="https://austinkleon.com/">Austin Kleon</a>. O objetivo do site é compartilhar assuntos de interesse profissional, para promover o conhecimento e receber feedback a cerca dos assuntos compartilhados. Meu trabalho é com o desenvolvimento e a manutenção de um software construído para auxiliar a gerenciar empresas de Agronegócio. As principais tecnologias que utilizo atualmente são <a class = "a-secondary" href="https://www.java.com/pt_BR/">Java</a>, <a class = "a-secondary" href='https://www.microsoft.com/SQL'>SQLServer</a> e <a class = "a-secondary" href='https://www.mysql.com/'>MySQL</a>.
        </p>
      </div>
